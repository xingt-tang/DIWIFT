...
def lasso(tr_ds, val_ds, te_ds, feature_idx, model_pl='latents/synthetic_data_syn1/', iteration=300, seed=0,
          gpu_on=False, save_model=False, n_trials=100, **unused):
    progress = WorkSplitter()

    progress.section("LASSO: Set the random seed")
    setup_seed(seed)

    progress.section("LASSO: Training")
    tuner = Tuner()
